...
def check_Orbit():
	...
	for m in range(1, 13):
	    for d in range(1, 31):
	        if(m < 10 and d < 10):
	            dateStr = '2012' + '.0' + str(m) + '.0' + str(d)
	            dateOrb = '2012' + '-0' + str(m) + '-0' + str(d)
	        elif(m<10 and d >= 10):
	            dateStr = '2012' + '.0' + str(m) + '.' + str(d)
	            dateOrb = '2012' + '-0' + str(m) + '-' + str(d)
	        elif(m>=10 and d < 10):
	            dateStr = '2012' + '.' + str(m) + '.0' + str(d)
	            dateOrb = '2012' + '-' + str(m) + '-0' + str(d)
	        else:
	            dateStr = '2012' + '.' + str(m) + '.' + str(d)
	            dateOrb = '2012' + '-' + str(m) + '-' + str(d)
	...
	if not path.exists(os.path.join(dirpath, '2012.01.31')):
	    exist[ 'MISR/MI1B2E.003' + '/' + '2012.01.31'] = 'Date Doesnot Exist'

	if not path.exists(os.path.join(dirpath, '2012.03.31')):
	    exist[ 'MISR/MI1B2E.003' + '/' + '2012.03.31'] = 'Date Doesnot Exist'

	if not path.exists(os.path.join(dirpath, '2012.05.31')):
	    exist[ 'MISR/MI1B2E.003' + '/' + '2012.05.31'] = 'Date Doesnot Exist'

	if not path.exists(os.path.join(dirpath, '2012.07.31')):
	    exist[ 'MISR/MI1B2E.003' + '/' + '2012.07.31'] = 'Date Doesnot Exist'

	if not path.exists(os.path.join(dirpath, '2012.08.31')):
	    exist[ 'MISR/MI1B2E.003' + '/' + '2012.08.31'] = 'Date Doesnot Exist'

	if not path.exists(os.path.join(dirpath, '2012.10.31')):
	    exist[ 'MISR/MI1B2E.003' + '/' + '2012.10.31'] = 'Date Doesnot Exist'

	if not path.exists(os.path.join(dirpath, '2012.12.31')):
	    exist[ 'MISR/MI1B2E.003' + '/' + '2012.12.31'] = 'Date Doesnot Exist'

	#deleting extra days from the month of Feb
	#del exist['MISR/MI1B2E.003' + '/' + '2012.02.29']
	del exist['MISR/MI1B2E.003' + '/' + '2012.02.30']
